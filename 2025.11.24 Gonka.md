...
gonka-account-key \
gonka1fnvgq0quyl3sxsszcfpxkvqs46nfksqwvfgwd9 \
...
curl http://node2.gonka.ai:8000/v1/participants | jq -r '.participants[] | select(.url=="http://183.251.64.217:8000")'

## 将返回自己的公钥，这表示你的地址已被包含在参与者列表中  - 替换为自己的冷钱包地址
curl http://node2.gonka.ai:8000/v1/participants/gonka1zs04qud0wnca4ryp4vu7888nfr3gl5q9hhaf7e
