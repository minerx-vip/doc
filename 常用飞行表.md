...
## Rigel
http://flight.minerx.vip/rigel/rigel-1.23.2.a.tar.gz

## SRBMiner
http://flight.minerx.vip/srbminer/srbminer-3.4.3.a.tar.gz
...
## 飞行表 - Rigel
{
    ...
    "customConfig": {
        "customMiner": "rigel",
        "customInstallUrl": "http://flight.minerx.vip/rigel/rigel-1.23.2.a.tar.gz",
        "customAlgo": "kawpow",
        "customTemplate": "%WAL%",
...
申请 Token：https://pool.qubic.li/en-US/settings

锄头：https://github.com/qubic-li/hiveos

#### 1.官方池 - CPU - 2026.03.20 更新
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/qubic/qubminer-3.6.1.tar.gz",
        "customAlgo": "---",
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/qubic/apoolminer_hiveos-v3.7.1.tar.gz",
        "customTemplate": "%WAL%",
...
```json
{
    ...
    "customConfig": {
        "customMiner": "xmrig",
        "customInstallUrl": "http://flight.minerx.vip/xmrig/xmrig-v6.25.0.a.tar.gz",
        "customAlgo": "---",
        "customTemplate": "%WAL%.%WORKER_NAME%",
...
```json
{
    ...
    "customConfig": {
        "customMiner": "miniZ",
        "customInstallUrl": "http://flight.minerx.vip/flux/miniZ-v2.5e.b.tar.gz",
        "customTemplate": "%WAL%.%WORKER_NAME%",
        "customUrl": "hk.flux.gfwroute.com:1200"
    }
}
...
```ini
{
    ...
    "customConfig": {
        "customMiner": "lolMiner",
        "customInstallUrl": "http://flight.minerx.vip/lolMiner/lolMiner-1.98.a.tar.gz",
        "customAlgo": "OCTOPUS",
        "customTemplate": "%WAL%.%WORKER_NAME%",
...
矿池列表：https://miningpoolstats.stream/ironfish

币信息：https://coinmarketcap.com/currencies/iron-fish/

```json
{
    "flightName": "ironfish",
    "descMsg": "ironfish - rigel",
    "digitalCash": "IronFish",
    "miningPool": "1",
    "miningConfig": "Custom",
    "disableFaultCard": true,
    "customConfig": {
        "customMiner": "rigel",
        "customInstallUrl": "https://minerx-download.oss-cn-shanghai.aliyuncs.com/flight/rigel/rigel-1.22.2.c.tar.gz",
        "customAlgo": "fishhash",
        "customTemplate": "%WAL%.%WORKER_NAME%",
        "customUrl": "stratum+tcp://hk.ironfish.gfwroute.com:1145",
        "customPass": "",
        "customUserConfig": "-o stratum+tcp://kr.ironfish.gfwroute.com:1145 -o stratum+tcp://sg.ironfish.gfwroute.com:1145 -o stratum+tcp://ru.ironfish.gfwroute.com:1145"
    }
}
```
...
交易所：https://www.gate.com/zh/trade/GRIN_USDT

交易所：https://tradeogre.com/exchange/GRIN-USDT

矿池：https://grin.2miners.com/help
...
```json
{
    ...
    "customConfig": {
        "customMiner": "gminer",
        "customInstallUrl": "http://flight.minerx.vip/gminer/gminer-3.44.5.tar.gz",
        "customAlgo": "cuckatoo32",
        "customTemplate": "%WAL%.%WORKER_NAME%",
        "customUrl": "grin.2miners.com:3030",
        "customPass": "",
        "customUserConfig": ""
    }
}
...
```json
{
    ...
    "customConfig": {
        ...
        "customUrl": "grin.2miners.com:3030",
        "customPass": "",
        "customUserConfig": "--coin GRIN-C32"
    }
}
```
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/onezerominer/onezerominer-1.7.4.tar.gz",
        "customAlgo": "xelishashv3",
        "customTemplate": "%WAL%.%WORKER_NAME%",
        "customUrl": "kr.xelis.gfwroute.com:1225",
        "customPass": "",
        "customUserConfig": ""
    },
    "isDefault": false
...
```json
{
    ...
    "customConfig": {
        ...
        "customAlgo": "xelishashv3",
        "customTemplate": "%WAL%.%WORKER_NAME%",
        "customUrl": "stratum+tcp://hk.xelis.gfwroute.com:1225",
        "customPass": "",
        "customUserConfig": "--no-tui -o stratum+tcp://hk.xelis.gfwroute.com:1225 -o stratum+tcp://kr.xelis.gfwroute.com:1225 -o stratum+tcp://sg.xelis.gfwroute.com:1225"
    },
    "isDefault": false
}
```
