...
## SRBMiner
http://flight.minerx.vip/srbminer/srbminer-3.2.2.a.tar.gz
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/qubic/qubminer-3.5.2.beta.tar.gz",
        "customAlgo": "---",
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/qubic/apoolminer_hiveos_autoupdate-v3.5.5.tar.gz",
        "customTemplate": "%WAL%",
