...
## SRBMiner
http://flight.minerx.vip/srbminer/srbminer-3.1.1.a.tar.gz
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/qubic/apoolminer_hiveos-v3.4.0.tar.gz",
        "customTemplate": "%WAL%",
...
## 单挖 Qubic
{
    ...
    "customConfig": {
        "customMiner": "apoolminer_hiveos",
        "customInstallUrl": "http://flight.minerx.vip/qubic/apoolminer_hiveos-v3.3.0.a.tar.gz",
        "customTemplate": "%WAL%",
        "customUrl": "qubic2.hk.apool.io:3334",
