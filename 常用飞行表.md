...
## SRBMiner
http://flight.minerx.vip/srbminer/srbminer-3.0.5.a.tar.gz
...
## 飞行表 - Rigel
{
    ...
    "customConfig": {
        "customMiner": "rigel",
        "customInstallUrl": "http://flight.minerx.vip/rigel/rigel-1.22.2.c.tar.gz",
        "customAlgo": "kawpow",
        "customTemplate": "%WAL%",
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/qubic/qubminer-3.3.9.1.tar.gz",
        "customAlgo": "---",
...
```json
{
    ...
    "customConfig": {
        "customMiner": "qubminer",
        "customInstallUrl": "http://flight.minerx.vip/qubic/qubminer-3.3.9.1.tar.g",
        "customAlgo": "---",
        "customTemplate": "%WORKER_NAME%",
        "customUrl": "",
        "customPass": "",
...
```json
{
    ...
    "customConfig": {
        "customMiner": "apoolminer_hiveos",
        "customInstallUrl": "http://flight.minerx.vip/qubic/apoolminer_hiveos-v3.2.3.tar.gz",
        "customTemplate": "%WAL%",
        "customUrl": "qubic2.hk.apool.io:3334",
