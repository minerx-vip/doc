...
## Apool - Qubic 单挖 - 2025.02.24

```ini
## 挖矿软件名称
apoolminer_hiveos_autoupdate

## 安装连接
https://github.com/apool-io/apoolminer/releases/download/v2.8.2/apoolminer_hiveos_autoupdate-v2.8.2.tar.gz
...
## 飞行表2
{
    ...
    "customConfig": {
        "customMiner": "rigel",
        "customInstallUrl": "https://minerx-download.oss-cn-shanghai.aliyuncs.com/rigel/rigel-1.20.1.tar.gz",
        "customAlgo": "kawpow",
        "customTemplate": "%WAL%",
...
```json
{
    "flightName": "qubic_apool",
    "descMsg": "qubic_apool 显卡",
    "digitalCash": "Qubic",
    "miningPool": "1",
    "miningConfig": "Custom",
    "disableFaultCard": false,
    "customConfig": {
        ...
        "customInstallUrl": "https://minerx-download.oss-cn-shanghai.aliyuncs.com/qubic/apoolminer_hiveos-v2.8.7.tar.gz",
        "customTemplate": "%WAL%",
...
```ini
## 钱包地址
0xaBc328080c9f97a2785327e1847b75f385fFa3C3

## 助记词
tuneless shimmies laagered couthy hippie modernly tasting thrived lobing metering ordinate quest adipsia ogreish christom
```
...
```json
{
    ...
    "customConfig": {
        "customMiner": "rigel",
        "customInstallUrl": "https://minerx-download.oss-cn-shanghai.aliyuncs.com/rigel/rigel-1.21.3.1.tar.gz",
        "customAlgo": "quai",
        "customTemplate": "%WAL%.%WORKER_NAME%",
