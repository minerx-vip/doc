...
SWAP：https://app.openocean.finance/swap/base/B0X_0xa9520fc8c54691af586544ad13db954afc345cd4/ETH

浏览器上查询代币余额 (将最后的替换为自己的钱包地址)：https://basescan.org/token/0xa9520fc8c54691af586544ad13db954afc345cd4?a=0x488029e8905xxxxxx

交易所：https://avedex.cc/token/0xa9520fc8c54691af586544ad13db954afc345cd4-base?from=Home
...
官方于2025.11.03 更新了新的合约地址

#### 老合约地址

- 选择 Base 链

- 合约地址：0xa9520fc8c54691af586544ad13db954afc345cd4
- 代币符号：b0x
- 小数位：18
...
- 合约地址：0x6B19E31C1813cD00b0d47d798601414b79A3e8AD
- 代币符号：b0x
- 小数位：18
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/b0x/b0x_miner-v1.7.3.k.tar.gz",
        "customAlgo": "---",
        "customTemplate": "%WAL%",
...
https://base.drpc.org
https://api.zan.top/base-mainnet
https://go.getblock.asia/081f585101dd4c33a7c8f17f50850770
https://1rpc.io/base
```
