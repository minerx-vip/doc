...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/npt/dr_neptune_prover_20.04-v3.1.0.a.tar.gz",
        "customAlgo": "---",
...
```json
{
    ...
    "customConfig": {
        "customMiner": "dr_neptune_prover",
        "customInstallUrl": "http://flight.minerx.vip/npt/dr_neptune_prover_24.04-v3.1.0.a.tar.gz",
        "customAlgo": "---",
        "customTemplate": "%WAL%.%WORKER_NAME%",
        "customUrl": "stratum+tcp://neptune.drpool.io:30127"
    }
