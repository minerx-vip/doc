...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/npt/dr_neptune_prover_20.04-v3.5.0.a.tar.gz",
        "customAlgo": "---",
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/npt/npt_h9_proxy-v1.0.1.b.tar.gz",
        "customAlgo": "---",
        "customTemplate": "%WAL%"
    }
}
...
```json
{
    ...
    "customConfig": {
        "customMiner": "npt_h9",
        "customInstallUrl": "http://flight.minerx.vip/npt/npt_h9-v1.0.3.a.tar.gz",
        "customAlgo": "---",
        "customTemplate": "%WAL%"
    }
}
