...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/npt/dr_neptune_prover_20.04-v3.4.2.a.tar.gz",
        "customAlgo": "---",
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/npt/npt_h9_proxy-v1.0.1.a.tar.gz",
        "customAlgo": "---",
        "customTemplate": "%WAL%"
    }
}
...
- 钱包
  ...
  - 钱包地址：填写 H9 矿池提供的 API Key (不管使用直连还是 Proxy 模式都需要在锄头上指定 API Key)
...
```json
{
    ...
    "customConfig": {
        "customMiner": "npt_h9",
        "customInstallUrl": "http://flight.minerx.vip/npt/npt_h9-v1.0.1.e.tar.gz",
        "customAlgo": "---",
        "customTemplate": "%WAL%"
    }
}
