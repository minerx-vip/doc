...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://114.215.172.228:8899/nockchain/nock_x_proxy-v1.0.4.1.a.tar.gz",
        "customTemplate": "%WAL%"
    }
}
```
...
```json
{
    ...
    "customConfig": {
        "customMiner": "nock_h9",
        "customInstallUrl": "http://114.215.172.228:8899/nockchain/nock_h9-1.0.5.1.b.tar.gz",
        "customTemplate": "%WAL%",
        "customUserConfig": ""
    }
}
...
```
https://github.com/h9-dev/nock-miner/releases/download/v1.0.2/h9-miner-nock-v1.0.2.2.tar.gz
```
