...
```sh
## 下载安装
wget -c http://flight.minerx.vip/nockchain/nockchain-wallet-20250928.tar.gz
tar vxzf nockchain-wallet-20250928.tar.gz
mv nockchain-wallet /usr/local/bin/
chmod +x /usr/local/bin/nockchain-wallet
```
