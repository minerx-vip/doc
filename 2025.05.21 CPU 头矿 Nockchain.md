...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/nock_glod/golden_proxy-v0.1.6.a.tar.gz",
        "customAlgo": "---",
        "customTemplate": "%WAL%",
        "customUserConfig": ""
    }
...
```json
{
    ...
    "customConfig": {
        "customMiner": "golden",
        "customInstallUrl": "http://flight.minerx.vip/nock_glod/golden-v0.1.6.a.tar.gz",
        "customAlgo": "---",
        "customTemplate": "%WAL%",
        "customUserConfig": ""
    }
