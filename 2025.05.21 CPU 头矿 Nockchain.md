...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://114.215.172.228:8899/nockchain/nock_x_proxy-v1.0.1.1.a.tar.gz",
        "customTemplate": "%WAL%"
    }
}
```
...
```json
{
    ...
    "customConfig": {
        "customMiner": "nock_h9",
        "customInstallUrl": "http://114.215.172.228:8899/nockchain/nock_h9-1.0.2.05.tar.gz",
        "customTemplate": "%WAL%",
        "customUserConfig": ""
    }
}
