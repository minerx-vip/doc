...
交易所：https://bitgoget.com/spot/LAXUSDT

交易所：https://app.exbitron.com/exchange/?market=LAX-USDT

交易所：https://safetrade.com/exchange/LAX-USDT?type=basic
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/srbminer/srbminer-3.0.2.a.tar.gz",
        "customAlgo": "xhash",
...
```json
{
    ...
    "customConfig": {
        "customMiner": "srbminer",
        "customInstallUrl": "http://flight.minerx.vip/srbminer/srbminer-3.0.0.a.tar.gz",
        "customAlgo": "xhash",
        "customTemplate": "%WAL%.%WORKER_NAME%",
