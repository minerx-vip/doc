...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/parallax/parallax_node-v1.1.0.a.tar.gz",
        "customAlgo": "---",
        "customTemplate": "%WAL%",
        "customUrl": "---",
        "customUserConfig": "--testnet --http.addr 0.0.0.0 --http.port 8545"
    }
}
```
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/parallax/parallax_miner-v1.1.0.a.tar.gz",
        "customAlgo": "---",
        "customTemplate": "%WAL%",
