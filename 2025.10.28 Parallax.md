...
交易所：https://bitgoget.com/signup?ref=BGGBDB0746E16
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://flight.minerx.vip/srbminer/srbminer-3.0.4.a.tar.gz",
        "customAlgo": "xhash",
...
```json
{
    ...
    "customConfig": {
        "customMiner": "srbminer",
        "customInstallUrl": "http://flight.minerx.vip/srbminer/srbminer-3.0.3.a.tar.gz",
        "customAlgo": "xhash",
        "customTemplate": "%WAL%.%WORKER_NAME%",
