...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://114.215.172.228:8899/qtc/onezerominer-1.5.7.d.tar.gz",
        "customAlgo": "qhash",
        "customTemplate": "%WAL%.%WORKER_NAME%",
...
```json
{
    ...
    "customConfig": {
        "customMiner": "wildrig",
        "customInstallUrl": "http://114.215.172.228:8899/wildrig-multi/wildrig-0.44.6.a.tar.gz",
        "customAlgo": "qhash",
        "customTemplate": "%WAL%.%WORKER_NAME%",
