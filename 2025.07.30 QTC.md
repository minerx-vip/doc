...
```ini
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://114.215.172.228:8899/qtc/qubitcoin_miner_cpu_custom-01.tar.gz",
        "customAlgo": "qhash",
...
```json
{
    ...
    "customConfig": {
        ...
        "customInstallUrl": "http://114.215.172.228:8899/qtc/qubitcoin_miner_gpu-10.tar.gz",
        "customAlgo": "qhash",
        "customTemplate": "%WAL%.%WORKER_NAME%",
        "customUrl": "47.239.148.5:30001",
        "customUserConfig": "--threads=4"
    }
}
```
...
> 低配机器带不动多显卡的，可以是只使用第一张显卡挖 QTC，其他显卡可以正常挖其他币
...
```json
{
    ...
    "disableFaultCard": true,
    "customConfig": {
        "customMiner": "qubitcoin_miner_gpu_0",
        "customInstallUrl": "http://114.215.172.228:8899/qtc/qubitcoin_miner_gpu_0-01.tar.gz",
        "customAlgo": "qhash",
        "customTemplate": "%WAL%.%WORKER_NAME%",
        "customUrl": "47.239.148.5:20001",
        "customUserConfig": "--threads=4"
    }
}
```
